...
import com.licenta.ServiceFinder.adapters.ServiceAutoAdapter;
import com.licenta.ServiceFinder.SharedPreferencesManager;
import com.licenta.ServiceFinder.activities.ServiceAutoActivity;
...
public class HomeFragment extends Fragment {
    ...
    private void init(View v) {
        ...
        mServiceAutoAdapter.setClickListener(new ServiceAutoAdapter.OnItemServiceAutoClickListener() {
            ...
            public void onItemServiceAutoClick(View view, int pos) {
                ...
                intent.putExtra("seenOffer", serviceAuto.getSeenOffers());
            ...
            public void onDeleteClick(View view, final int pos) {
                ...
                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.e(TAG, "onFailure: Something goes wrong to delete image from firebase");
    ...
    private boolean verifyInputOnServerSide() {
        ...
        jsonBody.addProperty("priceService", mPriceService.getText().toString().trim());
        jsonBody.addProperty("priceTire", mPriceTire.getText().toString().trim());
        jsonBody.addProperty("priceChassis", mPriceChassis.getText().toString().trim());
        jsonBody.addProperty("priceItp", mPriceItp.getText().toString().trim());
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                try {
                                    ...
                                    if (response.getHeaders().code() == 201) {
                                        ...
                                        populateServiceAutoList();
                                        ((HomeActivity) getActivity()).setNavigationView();
                                        ...
                                        mAddServiceProgressBar.setVisibility(View.GONE);
                                        mAddServiceLinearLayout.setBackground(new ColorDrawable(Color.parseColor("#FFFFFF")));
                                        resultOk[0] = false;
                                    }
                                } catch (ExecutionException e) {
                                    e.printStackTrace();
                                    ...
                                    if (!result.isEmpty()) {
                                        try {
                                            ...
                                            mServiceAutoList.add(new ServiceAuto(
                                                    ...
                                                    Uri.parse(service.getString("logoUrl")),
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            ...
            if (resultCode == 3) {
                ...
                serviceAuto.setCity(data.getStringExtra("newServiceCity"));
